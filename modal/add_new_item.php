			...
			<div class="modal-body">
				...
				<input type="hidden" id="item-id">
				  <div class="form-group">
				    ...
				    <div class="col-sm-9">
				      <input type="text" maxlength="50" class="form-control" id="item-name" placeholder="Enter Product Name" required="" autofocus="">
				    </div>
				  </div>
				  <div class="form-group">
				  ...
				  <div class="form-group">
				    ...
				    <div class="col-sm-9">
				      <input type="text" maxlength="50" class="form-control" id="grams" placeholder="Enter how many pieces" required="" autofocus="">
				    </div>
				  </div>
